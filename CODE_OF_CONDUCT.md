...
[GitHub](https://github.com/TikyParkinson/mcp-agent-guardrails-spring-boot-starter/issues)
(or privately via the contact options on the maintainer's GitHub profile). All complaints
will be reviewed and investigated promptly and fairly.

For the full text, including the enforcement guidelines, see
