 ...
 */
package io.github.tikyparkinson.mcpguardrails.core.application.port.in;
...
/** Inbound port: evaluates one tool invocation against every registered guardrail. */
public interface EvaluateToolInvocationUseCase {

  /** Runs all guardrails against the context and returns the aggregated verdict. */
